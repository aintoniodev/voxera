...
> Ronda 1: 2026-08-11, oyente1, 60 pares (15 clips × 4 pares).
> Ronda 2 (decisión): 3 oyentes (oyente1, oyente2, oyente3) × 5 pares difíciles
...
- Los empates altos (27-47%) son esperables: en clips ya limpios el master solo
  ...
  (p.ej. test_pc4_susurro y test_pc5_conversacion: MOS 1 para DF2 vs 3 para C).
- **DF3 suena subjetivamente mejor que DF2** (40% vs 13%) pese a perder en PESQ
  sintético — y a que en el benchmark real degradó test_pc4_susurro a casi
...
**3 oyentes** (oyente1, oyente2, oyente3), orden y lados A/B aleatorizados:

| Oyente | n | C (DF2+master) | B (DF2) | Empate | MOS C vs B |
|---|---|---|---|---|---|
| oyente1 | 15 | 8 (53%) | 4 (27%) | 3 | 3.20 vs 3.00 |
| oyente2 | 5 | 3 (60%) | 1 (20%) | 1 | 3.0 vs 3.0 |
| oyente3 | 5 | 4 (80%) | 1 (20%) | 0 | 3.0 vs 3.0 |
...
- Por clip (los 5 difíciles): C gana en 4 de 5 (pc5 3/3, susurro 2C+1tie,
