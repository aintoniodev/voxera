...
| [voxera-levitate.md](voxera-levitate.md) | `src/voxera/video_levitate.py` | Efecto "Levitación" (frame hold + sujeto congelado que flota sobre plate reconstruido), personas u objetos, trayectoria por keyframes P:X,Y[,ROT[,SCALE]], movimiento y sombra, ejemplos de ruta |
...
Las dos skills de short-form se distribuyen además como bundles portables
Codex en `plugins/`, con su `plugin.json`, referencias y scripts deterministas.
La skill de métricas pide los datos por bloques; la skill de edición convierte
el informe científico en un edit spec para el agente que ejecute el montaje.
